...
// give an alertMessage to display
// status have four options - warning , danger , success , info (each have its own color scheme)
//alert is on top of screen with postion fixed use it outside the scrollable component
  ...
  return (
    <>
      {open && (
        <div
          id="alert-border-1"
          className={`fixed bottom-0 left-0 right-0 flex items-center p-4  text-sm font-medium ${alertColor} border-l-4 border-solid ${borderColor} dark:bg-gray-800 dark:${borderColor} dark:${alertColor}} animation-fade-in z-100 `}
          role="alert"
        >
          <svg
